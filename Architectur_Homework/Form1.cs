...
namespace Architectur_Homework
{
    public partial class FrmOrder : Form
    {
        ...
        private void btn_Add_Click(object sender, EventArgs e)
        {
            ...
            if (checkBox_Strawberries.Checked)
            {
                txtCheckOut.Text += checkBox_Strawberries.Text + "\n";
                lstQty.Items.Add(comboBox_Quantity.Text);
                lstPrice.Items.Add(txtPrice.Text);
            }
            if (checkBox_Mango.Checked)
            {
                txtCheckOut.Text += checkBox_Mango.Text + "\n";
                lstQty.Items.Add(comboBox_Quantity.Text);
                lstPrice.Items.Add(txtPrice.Text);
            }           
        ...
        private void ChangeControlLayout(bool islanguage)
        {
            if (islanguage)
            {
                checkBox_Strawberries.Text = "فروله";
                checkBox_Arabic.Text = "عربي";
                checkBox_Orange.Text = "برتقال";
                checkBox_Mango.Text = "منجا";                
                label1.Text = "الكمية";
            ...
            else
            {
                ...
                btn_Add.Text = "Add";
                checkBox_Strawberries.Text = "Strawberries";
                checkBox_Orange.Text = "Orange";
                checkBox_Mango.Text = "Mango";
